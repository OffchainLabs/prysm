...
var file_proto_engine_v1_electra_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x73, 0x22, 0x9d, 0x02, 0x0a, 0x13,
	0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x75, 0x6e, 0x64, 0x6c, 0x65, 0x46,
	0x75, 0x6c, 0x75, 0x12, 0x43, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x18, 0x01,
	...
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x44,
	...
	0x75, 0x6e, 0x64, 0x6c, 0x65, 0x56, 0x32, 0x52, 0x0b, 0x62, 0x6c, 0x6f, 0x62, 0x73, 0x42, 0x75,
	0x6e, 0x64, 0x6c, 0x65, 0x12, 0x36, 0x0a, 0x17, 0x73, 0x68, 0x6f, 0x75, 0x6c, 0x64, 0x5f, 0x6f,
	0x76, 0x65, 0x72, 0x72, 0x69, 0x64, 0x65, 0x5f, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x65, 0x72, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x15, 0x73, 0x68, 0x6f, 0x75, 0x6c, 0x64, 0x4f, 0x76, 0x65,
	0x72, 0x72, 0x69, 0x64, 0x65, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x65, 0x72, 0x12, 0x2d, 0x0a, 0x12,
...
var file_proto_engine_v1_electra_proto_goTypes = []interface{}{
	...
	(*ExecutionBundleFulu)(nil),    // 5: ethereum.engine.v1.ExecutionBundleFulu
	(*ExecutionPayloadDeneb)(nil),  // 6: ethereum.engine.v1.ExecutionPayloadDeneb
	(*BlobsBundle)(nil),            // 7: ethereum.engine.v1.BlobsBundle
	(*BlobsBundleV2)(nil),          // 8: ethereum.engine.v1.BlobsBundleV2
}
var file_proto_engine_v1_electra_proto_depIdxs = []int32{
	...
	6, // 3: ethereum.engine.v1.ExecutionBundleElectra.payload:type_name -> ethereum.engine.v1.ExecutionPayloadDeneb
	7, // 4: ethereum.engine.v1.ExecutionBundleElectra.blobs_bundle:type_name -> ethereum.engine.v1.BlobsBundle
	6, // 5: ethereum.engine.v1.ExecutionBundleFulu.payload:type_name -> ethereum.engine.v1.ExecutionPayloadDeneb
	8, // 6: ethereum.engine.v1.ExecutionBundleFulu.blobs_bundle:type_name -> ethereum.engine.v1.BlobsBundleV2
...
func file_proto_engine_v1_electra_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_engine_v1_electra_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
