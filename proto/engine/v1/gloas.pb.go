...
func (x *SetSweepThresholdRequest) Reset() {
	*x = SetSweepThresholdRequest{}
	mi := &file_proto_engine_v1_gloas_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SetSweepThresholdRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetSweepThresholdRequest) ProtoMessage() {}

func (x *SetSweepThresholdRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_engine_v1_gloas_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetSweepThresholdRequest.ProtoReflect.Descriptor instead.
func (*SetSweepThresholdRequest) Descriptor() ([]byte, []int) {
	return file_proto_engine_v1_gloas_proto_rawDescGZIP(), []int{2}
}

func (x *SetSweepThresholdRequest) GetSourceAddress() []byte {
	if x != nil {
		return x.SourceAddress
	}
	return nil
...
func (x *SetSweepThresholdRequest) GetValidatorPubkey() []byte {
	if x != nil {
...
func (x *SetSweepThresholdRequest) GetThreshold() uint64 {
	if x != nil {
		return x.Threshold
	}
	return 0
...
type ExecutionRequestsGloas struct {
	...
	SweepThresholds []*SetSweepThresholdRequest `protobuf:"bytes,6,rep,name=sweep_thresholds,json=sweepThresholds,proto3" json:"sweep_thresholds,omitempty" ssz-max:"16"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *ExecutionRequestsGloas) GetSweepThresholds() []*SetSweepThresholdRequest {
	if x != nil {
		return x.SweepThresholds
	}
	return nil
}
...
var file_proto_engine_v1_gloas_proto_rawDesc = []byte{
	...
	0x38, 0x52, 0x06, 0x70, 0x75, 0x62, 0x6b, 0x65, 0x79, 0x22, 0x9a, 0x01, 0x0a, 0x18, 0x53, 0x65,
	0x74, 0x53, 0x77, 0x65, 0x65, 0x70, 0x54, 0x68, 0x72, 0x65, 0x73, 0x68, 0x6f, 0x6c, 0x64, 0x52,
	...
	0x6f, 0x72, 0x50, 0x75, 0x62, 0x6b, 0x65, 0x79, 0x12, 0x1c, 0x0a, 0x09, 0x74, 0x68, 0x72, 0x65,
	0x73, 0x68, 0x6f, 0x6c, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x09, 0x74, 0x68, 0x72,
	0x65, 0x73, 0x68, 0x6f, 0x6c, 0x64, 0x22, 0xa1, 0x04, 0x0a, 0x16, 0x45, 0x78, 0x65, 0x63, 0x75,
	...
	,
	...
	0x73, 0x6d, 0x2f, 0x76, 0x37, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x65, 0x6e, 0x67, 0x69,
...
var file_proto_engine_v1_gloas_proto_goTypes = []any{
	...
	(*SetSweepThresholdRequest)(nil), // 2: ethereum.engine.v1.SetSweepThresholdRequest
	(*ExecutionRequestsGloas)(nil),   // 3: ethereum.engine.v1.ExecutionRequestsGloas
...
var file_proto_engine_v1_gloas_proto_depIdxs = []int32{
	4, // 0: ethereum.engine.v1.ExecutionRequestsGloas.deposits:type_name -> ethereum.engine.v1.DepositRequest
	5, // 1: ethereum.engine.v1.ExecutionRequestsGloas.withdrawals:type_name -> ethereum.engine.v1.WithdrawalRequest
	6, // 2: ethereum.engine.v1.ExecutionRequestsGloas.consolidations:type_name -> ethereum.engine.v1.ConsolidationRequest
	...
	2, // 5: ethereum.engine.v1.ExecutionRequestsGloas.sweep_thresholds:type_name -> ethereum.engine.v1.SetSweepThresholdRequest
