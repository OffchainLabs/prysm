...
func (x *EventHead) GetSlot() github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.Slot {
	if x != nil {
		return x.Slot
	}
...
func (x *EventBlock) GetSlot() github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.Slot {
	if x != nil {
		return x.Slot
	}
	return github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.Slot(0)
...
type EventChainReorg struct {
	...
	Epoch               github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.Epoch `protobuf:"varint,7,opt,name=epoch,proto3" json:"epoch,omitempty" cast-type:"github.com/prysmaticlabs/prysm/v6/consensus-types/primitives.Epoch"`
...
func (x *EventChainReorg) GetSlot() github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.Slot {
	if x != nil {
		return x.Slot
	}
	return github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.Slot(0)
...
func (x *EventChainReorg) GetEpoch() github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.Epoch {
	if x != nil {
		return x.Epoch
	}
...
func (x *EventFinalizedCheckpoint) GetEpoch() github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.Epoch {
	if x != nil {
		return x.Epoch
	}
	return github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.Epoch(0)
