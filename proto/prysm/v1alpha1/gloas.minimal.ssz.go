...
func (c *SignedWireBlindedExecutionPayloadEnvelope) SizeSSZ() int {
	size := 100
	if c.Message == nil {
...
func (c *SignedWireBlindedExecutionPayloadEnvelope) MarshalSSZ() ([]byte, error) {
	buf := make([]byte, c.SizeSSZ())
	return c.MarshalSSZTo(buf[:0])
}

func (c *SignedWireBlindedExecutionPayloadEnvelope) MarshalSSZTo(dst []byte) ([]byte, error) {
	var err error
	offset := 100
...
func (c *SignedWireBlindedExecutionPayloadEnvelope) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 100 {
		return ssz.ErrSize
...
func (c *SignedWireBlindedExecutionPayloadEnvelope) HashTreeRoot() ([32]byte, error) {
	hh := ssz.DefaultHasherPool.Get()
	if err := c.HashTreeRootWith(hh); err != nil {
		ssz.DefaultHasherPool.Put(hh)
		return [32]byte{}, err
...
func (c *SignedWireBlindedExecutionPayloadEnvelope) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	// Field 0: Message
	if err := c.Message.HashTreeRootWith(hh); err != nil {
		return fmt.Errorf("Message: %w", err)
...
func (c *WireBlindedExecutionPayloadEnvelope) SizeSSZ() int {
	size := 108
	if c.ExecutionRequests == nil {
		c.ExecutionRequests = new(v1.ExecutionRequestsGloas)
	}
...
func (c *WireBlindedExecutionPayloadEnvelope) MarshalSSZ() ([]byte, error) {
	buf := make([]byte, c.SizeSSZ())
	return c.MarshalSSZTo(buf[:0])
}

func (c *WireBlindedExecutionPayloadEnvelope) MarshalSSZTo(dst []byte) ([]byte, error) {
	var err error
	offset := 108

	// Field 0: PayloadRoot
	if len(c.PayloadRoot) != 32 {
		return nil, ssz.ErrBytesLength
	}
	dst = append(dst, c.PayloadRoot...)
...
func (c *WireBlindedExecutionPayloadEnvelope) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 108 {
		return ssz.ErrSize
	...
	sszSlice0 := buf[0:32]   // c.PayloadRoot
	sszSlice2 := buf[36:44]  // c.BuilderIndex
	sszSlice3 := buf[44:76]  // c.BeaconBlockRoot
	sszSlice4 := buf[76:108] // c.ParentBeaconBlockRoot
	...
	// Field 0: PayloadRoot
	c.PayloadRoot = make([]byte, 0, 32)
	c.PayloadRoot = append(c.PayloadRoot, sszSlice0...)
...
func (c *WireBlindedExecutionPayloadEnvelope) HashTreeRoot() ([32]byte, error) {
	return c.ProgressiveHashTreeRoot()
}

func (c *WireBlindedExecutionPayloadEnvelope) HashTreeRootWith(hh *ssz.Hasher) error {
	return c.ProgressiveHashTreeRootWith(hh)
}

var activeFieldsWireBlindedExecutionPayloadEnvelope = []byte{0b00011111}

func (c *WireBlindedExecutionPayloadEnvelope) ProgressiveHashTreeRoot() ([32]byte, error) {
	hh := ssz.DefaultHasherPool.Get()
	if err := c.ProgressiveHashTreeRootWith(hh); err != nil {
		ssz.DefaultHasherPool.Put(hh)
		return [32]byte{}, err
...
func (c *WireBlindedExecutionPayloadEnvelope) ProgressiveHashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	// Field 0: PayloadRoot
	if len(c.PayloadRoot) != 32 {
		return ssz.ErrBytesLength
	...
	hh.PutBytes(c.ParentBeaconBlockRoot)
	hh.MerkleizeProgressiveWithActiveFields(indx, activeFieldsWireBlindedExecutionPayloadEnvelope)
	return nil
}
