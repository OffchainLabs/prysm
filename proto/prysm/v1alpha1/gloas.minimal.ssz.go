...
func (b *BeaconStateGloas) UnmarshalSSZ(buf []byte) error {
	...
	for ii := 0; ii < 16; ii++ {
		...
		if err = b.BuilderPendingPayments[ii].UnmarshalSSZ(buf[10489:11193][ii*44 : (ii+1)*44]); err != nil {
			return err
		}
	}

	// Offset (42) 'BuilderPendingWithdrawals'
	if o42 = ssz.ReadOffset(buf[11193:11197]); o42 > size || o38 > o42 {
		return ssz.ErrOffset
	}

	// Offset (43) 'LatestExecutionPayloadBid'
	if o43 = ssz.ReadOffset(buf[11197:11201]); o43 > size || o42 > o43 {
		return ssz.ErrOffset
	}

	// Offset (44) 'PayloadExpectedWithdrawals'
	if o44 = ssz.ReadOffset(buf[11201:11205]); o44 > size || o43 > o44 {
		return ssz.ErrOffset
	}
	...
	for ii := 0; ii < 24; ii++ {
		...
		if err = b.PtcWindow[ii].UnmarshalSSZ(buf[11205:14277][ii*128 : (ii+1)*128]); err != nil {
			return err
		}
	}
