...
func (*BeaconCommittees_CommitteeItem) Descriptor() ([]byte, []int) {
	return file_proto_prysm_v1alpha1_beacon_chain_proto_rawDescGZIP(), []int{8, 0}
}
...
func (*BeaconCommittees_CommitteesList) Descriptor() ([]byte, []int) {
	return file_proto_prysm_v1alpha1_beacon_chain_proto_rawDescGZIP(), []int{8, 1}
}
...
func (*ValidatorAssignments_CommitteeAssignment) Descriptor() ([]byte, []int) {
	return file_proto_prysm_v1alpha1_beacon_chain_proto_rawDescGZIP(), []int{20, 0}
}
...
var file_proto_prysm_v1alpha1_beacon_chain_proto_rawDesc = []byte{
	...
	0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x22, 0xca, 0x01, 0x0a, 0x1f, 0x4c, 0x69, 0x73, 0x74, 0x49,
	...
	0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x32, 0x87, 0x1a, 0x0a, 0x0b,
	0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x43, 0x68, 0x61, 0x69, 0x6e, 0x12, 0xbe, 0x01, 0x0a, 0x17,
...
var file_proto_prysm_v1alpha1_beacon_chain_proto_goTypes = []any{
	...
	(*ListIndexedAttestationsResponse)(nil),          // 1: ethereum.eth.v1alpha1.ListIndexedAttestationsResponse
	(*ListIndexedAttestationsElectraResponse)(nil),   // 2: ethereum.eth.v1alpha1.ListIndexedAttestationsElectraResponse
	(*ListBlocksRequest)(nil),                        // 3: ethereum.eth.v1alpha1.ListBlocksRequest
	(*ListBeaconBlocksResponse)(nil),                 // 4: ethereum.eth.v1alpha1.ListBeaconBlocksResponse
	(*BeaconBlockContainer)(nil),                     // 5: ethereum.eth.v1alpha1.BeaconBlockContainer
	(*ChainHead)(nil),                                // 6: ethereum.eth.v1alpha1.ChainHead
	(*ListCommitteesRequest)(nil),                    // 7: ethereum.eth.v1alpha1.ListCommitteesRequest
	(*BeaconCommittees)(nil),                         // 8: ethereum.eth.v1alpha1.BeaconCommittees
	(*ListValidatorBalancesRequest)(nil),             // 9: ethereum.eth.v1alpha1.ListValidatorBalancesRequest
	(*ValidatorBalances)(nil),                        // 10: ethereum.eth.v1alpha1.ValidatorBalances
	(*ListValidatorsRequest)(nil),                    // 11: ethereum.eth.v1alpha1.ListValidatorsRequest
	(*GetValidatorRequest)(nil),                      // 12: ethereum.eth.v1alpha1.GetValidatorRequest
	(*Validators)(nil),                               // 13: ethereum.eth.v1alpha1.Validators
	(*GetValidatorActiveSetChangesRequest)(nil),      // 14: ethereum.eth.v1alpha1.GetValidatorActiveSetChangesRequest
	(*ActiveSetChanges)(nil),                         // 15: ethereum.eth.v1alpha1.ActiveSetChanges
	(*ValidatorPerformanceRequest)(nil),              // 16: ethereum.eth.v1alpha1.ValidatorPerformanceRequest
	(*ValidatorPerformanceResponse)(nil),             // 17: ethereum.eth.v1alpha1.ValidatorPerformanceResponse
	(*ValidatorQueue)(nil),                           // 18: ethereum.eth.v1alpha1.ValidatorQueue
	(*ListValidatorAssignmentsRequest)(nil),          // 19: ethereum.eth.v1alpha1.ListValidatorAssignmentsRequest
	(*ValidatorAssignments)(nil),                     // 20: ethereum.eth.v1alpha1.ValidatorAssignments
	(*GetValidatorParticipationRequest)(nil),         // 21: ethereum.eth.v1alpha1.GetValidatorParticipationRequest
	(*ValidatorParticipationResponse)(nil),           // 22: ethereum.eth.v1alpha1.ValidatorParticipationResponse
	(*AttestationPoolRequest)(nil),                   // 23: ethereum.eth.v1alpha1.AttestationPoolRequest
	(*AttestationPoolResponse)(nil),                  // 24: ethereum.eth.v1alpha1.AttestationPoolResponse
	(*AttestationPoolElectraResponse)(nil),           // 25: ethereum.eth.v1alpha1.AttestationPoolElectraResponse
	...
	(*IndexedAttestationElectra)(nil),             // 39: ethereum.eth.v1alpha1.IndexedAttestationElectra
	...
	(*SignedBeaconBlockFulu)(nil),                 // 50: ethereum.eth.v1alpha1.SignedBeaconBlockFulu
	(*SignedBlindedBeaconBlockFulu)(nil),          // 51: ethereum.eth.v1alpha1.SignedBlindedBeaconBlockFulu
	(*ValidatorParticipation)(nil),                // 52: ethereum.eth.v1alpha1.ValidatorParticipation
	(*Attestation)(nil),                           // 53: ethereum.eth.v1alpha1.Attestation
	(*AttestationElectra)(nil),                    // 54: ethereum.eth.v1alpha1.AttestationElectra
	(*Validator)(nil),                             // 55: ethereum.eth.v1alpha1.Validator
	(*emptypb.Empty)(nil),                         // 56: google.protobuf.Empty
	(*AttesterSlashing)(nil),                      // 57: ethereum.eth.v1alpha1.AttesterSlashing
	(*AttesterSlashingElectra)(nil),               // 58: ethereum.eth.v1alpha1.AttesterSlashingElectra
...
var file_proto_prysm_v1alpha1_beacon_chain_proto_depIdxs = []int32{
	38, // 0: ethereum.eth.v1alpha1.ListIndexedAttestationsResponse.indexed_attestations:type_name -> ethereum.eth.v1alpha1.IndexedAttestation
	39, // 1: ethereum.eth.v1alpha1.ListIndexedAttestationsElectraResponse.indexed_attestations:type_name -> ethereum.eth.v1alpha1.IndexedAttestationElectra
	5,  // 2: ethereum.eth.v1alpha1.ListBeaconBlocksResponse.block_containers:type_name -> ethereum.eth.v1alpha1.BeaconBlockContainer
	...
	50, // 13: ethereum.eth.v1alpha1.BeaconBlockContainer.fulu_block:type_name -> ethereum.eth.v1alpha1.SignedBeaconBlockFulu
	51, // 14: ethereum.eth.v1alpha1.BeaconBlockContainer.blinded_fulu_block:type_name -> ethereum.eth.v1alpha1.SignedBlindedBeaconBlockFulu
	32, // 15: ethereum.eth.v1alpha1.BeaconCommittees.committees:type_name -> ethereum.eth.v1alpha1.BeaconCommittees.CommitteesEntry
	33, // 16: ethereum.eth.v1alpha1.ValidatorBalances.balances:type_name -> ethereum.eth.v1alpha1.ValidatorBalances.Balance
	34, // 17: ethereum.eth.v1alpha1.Validators.validator_list:type_name -> ethereum.eth.v1alpha1.Validators.ValidatorContainer
	35, // 18: ethereum.eth.v1alpha1.ValidatorAssignments.assignments:type_name -> ethereum.eth.v1alpha1.ValidatorAssignments.CommitteeAssignment
	52, // 19: ethereum.eth.v1alpha1.ValidatorParticipationResponse.participation:type_name -> ethereum.eth.v1alpha1.ValidatorParticipation
	53, // 20: ethereum.eth.v1alpha1.AttestationPoolResponse.attestations:type_name -> ethereum.eth.v1alpha1.Attestation
	54, // 21: ethereum.eth.v1alpha1.AttestationPoolElectraResponse.attestations:type_name -> ethereum.eth.v1alpha1.AttestationElectra
	36, // 22: ethereum.eth.v1alpha1.BeaconConfig.config:type_name -> ethereum.eth.v1alpha1.BeaconConfig.ConfigEntry
	37, // 23: ethereum.eth.v1alpha1.IndividualVotesRespond.individual_votes:type_name -> ethereum.eth.v1alpha1.IndividualVotesRespond.IndividualVote
	30, // 24: ethereum.eth.v1alpha1.BeaconCommittees.CommitteesList.committees:type_name -> ethereum.eth.v1alpha1.BeaconCommittees.CommitteeItem
	31, // 25: ethereum.eth.v1alpha1.BeaconCommittees.CommitteesEntry.value:type_name -> ethereum.eth.v1alpha1.BeaconCommittees.CommitteesList
	55, // 26: ethereum.eth.v1alpha1.Validators.ValidatorContainer.validator:type_name -> ethereum.eth.v1alpha1.Validator
	0,  // 27: ethereum.eth.v1alpha1.BeaconChain.ListIndexedAttestations:input_type -> ethereum.eth.v1alpha1.ListIndexedAttestationsRequest
	0,  // 28: ethereum.eth.v1alpha1.BeaconChain.ListIndexedAttestationsElectra:input_type -> ethereum.eth.v1alpha1.ListIndexedAttestationsRequest
	23, // 29: ethereum.eth.v1alpha1.BeaconChain.AttestationPool:input_type -> ethereum.eth.v1alpha1.AttestationPoolRequest
	23, // 30: ethereum.eth.v1alpha1.BeaconChain.AttestationPoolElectra:input_type -> ethereum.eth.v1alpha1.AttestationPoolRequest
	3,  // 31: ethereum.eth.v1alpha1.BeaconChain.ListBeaconBlocks:input_type -> ethereum.eth.v1alpha1.ListBlocksRequest
	56, // 32: ethereum.eth.v1alpha1.BeaconChain.GetChainHead:input_type -> google.protobuf.Empty
	7,  // 33: ethereum.eth.v1alpha1.BeaconChain.ListBeaconCommittees:input_type -> ethereum.eth.v1alpha1.ListCommitteesRequest
	9,  // 34: ethereum.eth.v1alpha1.BeaconChain.ListValidatorBalances:input_type -> ethereum.eth.v1alpha1.ListValidatorBalancesRequest
	11, // 35: ethereum.eth.v1alpha1.BeaconChain.ListValidators:input_type -> ethereum.eth.v1alpha1.ListValidatorsRequest
	12, // 36: ethereum.eth.v1alpha1.BeaconChain.GetValidator:input_type -> ethereum.eth.v1alpha1.GetValidatorRequest
	14, // 37: ethereum.eth.v1alpha1.BeaconChain.GetValidatorActiveSetChanges:input_type -> ethereum.eth.v1alpha1.GetValidatorActiveSetChangesRequest
	56, // 38: ethereum.eth.v1alpha1.BeaconChain.GetValidatorQueue:input_type -> google.protobuf.Empty
	16, // 39: ethereum.eth.v1alpha1.BeaconChain.GetValidatorPerformance:input_type -> ethereum.eth.v1alpha1.ValidatorPerformanceRequest
	19, // 40: ethereum.eth.v1alpha1.BeaconChain.ListValidatorAssignments:input_type -> ethereum.eth.v1alpha1.ListValidatorAssignmentsRequest
	21, // 41: ethereum.eth.v1alpha1.BeaconChain.GetValidatorParticipation:input_type -> ethereum.eth.v1alpha1.GetValidatorParticipationRequest
	56, // 42: ethereum.eth.v1alpha1.BeaconChain.GetBeaconConfig:input_type -> google.protobuf.Empty
	57, // 43: ethereum.eth.v1alpha1.BeaconChain.SubmitAttesterSlashing:input_type -> ethereum.eth.v1alpha1.AttesterSlashing
	58, // 44: ethereum.eth.v1alpha1.BeaconChain.SubmitAttesterSlashingElectra:input_type -> ethereum.eth.v1alpha1.AttesterSlashingElectra
	59, // 45: ethereum.eth.v1alpha1.BeaconChain.SubmitProposerSlashing:input_type -> ethereum.eth.v1alpha1.ProposerSlashing
	28, // 46: ethereum.eth.v1alpha1.BeaconChain.GetIndividualVotes:input_type -> ethereum.eth.v1alpha1.IndividualVotesRequest
	1,  // 47: ethereum.eth.v1alpha1.BeaconChain.ListIndexedAttestations:output_type -> ethereum.eth.v1alpha1.ListIndexedAttestationsResponse
	2,  // 48: ethereum.eth.v1alpha1.BeaconChain.ListIndexedAttestationsElectra:output_type -> ethereum.eth.v1alpha1.ListIndexedAttestationsElectraResponse
	24, // 49: ethereum.eth.v1alpha1.BeaconChain.AttestationPool:output_type -> ethereum.eth.v1alpha1.AttestationPoolResponse
	25, // 50: ethereum.eth.v1alpha1.BeaconChain.AttestationPoolElectra:output_type -> ethereum.eth.v1alpha1.AttestationPoolElectraResponse
	4,  // 51: ethereum.eth.v1alpha1.BeaconChain.ListBeaconBlocks:output_type -> ethereum.eth.v1alpha1.ListBeaconBlocksResponse
	6,  // 52: ethereum.eth.v1alpha1.BeaconChain.GetChainHead:output_type -> ethereum.eth.v1alpha1.ChainHead
	8,  // 53: ethereum.eth.v1alpha1.BeaconChain.ListBeaconCommittees:output_type -> ethereum.eth.v1alpha1.BeaconCommittees
	10, // 54: ethereum.eth.v1alpha1.BeaconChain.ListValidatorBalances:output_type -> ethereum.eth.v1alpha1.ValidatorBalances
	13, // 55: ethereum.eth.v1alpha1.BeaconChain.ListValidators:output_type -> ethereum.eth.v1alpha1.Validators
	55, // 56: ethereum.eth.v1alpha1.BeaconChain.GetValidator:output_type -> ethereum.eth.v1alpha1.Validator
	15, // 57: ethereum.eth.v1alpha1.BeaconChain.GetValidatorActiveSetChanges:output_type -> ethereum.eth.v1alpha1.ActiveSetChanges
	18, // 58: ethereum.eth.v1alpha1.BeaconChain.GetValidatorQueue:output_type -> ethereum.eth.v1alpha1.ValidatorQueue
	17, // 59: ethereum.eth.v1alpha1.BeaconChain.GetValidatorPerformance:output_type -> ethereum.eth.v1alpha1.ValidatorPerformanceResponse
	20, // 60: ethereum.eth.v1alpha1.BeaconChain.ListValidatorAssignments:output_type -> ethereum.eth.v1alpha1.ValidatorAssignments
	22, // 61: ethereum.eth.v1alpha1.BeaconChain.GetValidatorParticipation:output_type -> ethereum.eth.v1alpha1.ValidatorParticipationResponse
	26, // 62: ethereum.eth.v1alpha1.BeaconChain.GetBeaconConfig:output_type -> ethereum.eth.v1alpha1.BeaconConfig
	27, // 63: ethereum.eth.v1alpha1.BeaconChain.SubmitAttesterSlashing:output_type -> ethereum.eth.v1alpha1.SubmitSlashingResponse
	27, // 64: ethereum.eth.v1alpha1.BeaconChain.SubmitAttesterSlashingElectra:output_type -> ethereum.eth.v1alpha1.SubmitSlashingResponse
	27, // 65: ethereum.eth.v1alpha1.BeaconChain.SubmitProposerSlashing:output_type -> ethereum.eth.v1alpha1.SubmitSlashingResponse
	29, // 66: ethereum.eth.v1alpha1.BeaconChain.GetIndividualVotes:output_type -> ethereum.eth.v1alpha1.IndividualVotesRespond
...
func file_proto_prysm_v1alpha1_beacon_chain_proto_init() {
	...
	file_proto_prysm_v1alpha1_beacon_chain_proto_msgTypes[3].OneofWrappers = []any{
		(*ListBlocksRequest_Root)(nil),
		(*ListBlocksRequest_Slot)(nil),
		(*ListBlocksRequest_Epoch)(nil),
		(*ListBlocksRequest_Genesis)(nil),
	}
	file_proto_prysm_v1alpha1_beacon_chain_proto_msgTypes[5].OneofWrappers = []any{
	...
	file_proto_prysm_v1alpha1_beacon_chain_proto_msgTypes[7].OneofWrappers = []any{
	...
	file_proto_prysm_v1alpha1_beacon_chain_proto_msgTypes[19].OneofWrappers = []any{
		(*ListValidatorAssignmentsRequest_Epoch)(nil),
		(*ListValidatorAssignmentsRequest_Genesis)(nil),
	}
	file_proto_prysm_v1alpha1_beacon_chain_proto_msgTypes[21].OneofWrappers = []any{
