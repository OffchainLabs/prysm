...
func (c *PartialDataColumnHeader) HashTreeRootWith(hh *ssz.Hasher) error {
	return c.ProgressiveHashTreeRootWith(hh)
}

var activeFieldsPartialDataColumnHeader = []byte{0b00000111}

func (c *PartialDataColumnHeader) ProgressiveHashTreeRoot() ([32]byte, error) {
	hh := ssz.DefaultHasherPool.Get()
...
func (c *PartialDataColumnHeader) ProgressiveHashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	// Field 0: KzgCommitments
	{
		subIndx := hh.Index()
		...
		hh.MerkleizeProgressiveWithMixin(subIndx, uint64(len(c.KzgCommitments)))
	}
	// Field 1: SignedBlockHeader
	if err := c.SignedBlockHeader.HashTreeRootWith(hh); err != nil {
		return fmt.Errorf("SignedBlockHeader: %w", err)
	...
	hh.MerkleizeProgressiveWithActiveFields(indx, activeFieldsPartialDataColumnHeader)
	return nil
}
...
func (c *PartialDataColumnPartsMetadata) UnmarshalSSZ(buf []byte) error {
	...
	// Field 1: Requests
	if err = ssz.ValidateProgressiveBitlist(sszSlice1); err != nil {
...
func (c *PartialDataColumnPartsMetadata) HashTreeRootWith(hh *ssz.Hasher) error {
	return c.ProgressiveHashTreeRootWith(hh)
}

var activeFieldsPartialDataColumnPartsMetadata = []byte{0b00000011}

func (c *PartialDataColumnPartsMetadata) ProgressiveHashTreeRoot() ([32]byte, error) {
	hh := ssz.DefaultHasherPool.Get()
	if err := c.ProgressiveHashTreeRootWith(hh); err != nil {
		ssz.DefaultHasherPool.Put(hh)
		return [32]byte{}, err
...
func (c *PartialDataColumnPartsMetadata) ProgressiveHashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	// Field 0: Available
	if len(c.Available) == 0 {
		return ssz.ErrEmptyBitlist
	}
	hh.PutProgressiveBitlist(c.Available)
	// Field 1: Requests
	if len(c.Requests) == 0 {
		return ssz.ErrEmptyBitlist
	}
	hh.PutProgressiveBitlist(c.Requests)
	hh.MerkleizeProgressiveWithActiveFields(indx, activeFieldsPartialDataColumnPartsMetadata)
	return nil
}
...
func (c *PartialDataColumnSidecar) HashTreeRootWith(hh *ssz.Hasher) error {
	return c.ProgressiveHashTreeRootWith(hh)
}

var activeFieldsPartialDataColumnSidecar = []byte{0b00001111}

func (c *PartialDataColumnSidecar) ProgressiveHashTreeRoot() ([32]byte, error) {
	hh := ssz.DefaultHasherPool.Get()
	if err := c.ProgressiveHashTreeRootWith(hh); err != nil {
		ssz.DefaultHasherPool.Put(hh)
		return [32]byte{}, err
...
func (c *PartialDataColumnSidecar) ProgressiveHashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	// Field 0: CellsPresentBitmap
	...
	// Field 3: Header
	{
		...
		hh.MerkleizeProgressiveWithMixin(subIndx, uint64(len(c.Header)))
	}
	hh.MerkleizeProgressiveWithActiveFields(indx, activeFieldsPartialDataColumnSidecar)
	return nil
}
