...
type BLSToExecutionChange struct {
	...
	ValidatorIndex     github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.ValidatorIndex `protobuf:"varint,1,opt,name=validator_index,json=validatorIndex,proto3" json:"validator_index,omitempty" cast-type:"github.com/prysmaticlabs/prysm/v6/consensus-types/primitives.ValidatorIndex"`
...
func (x *BLSToExecutionChange) GetValidatorIndex() github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.ValidatorIndex {
	if x != nil {
