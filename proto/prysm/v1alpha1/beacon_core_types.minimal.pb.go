...
func (*StateSummary) Descriptor() ([]byte, []int) {
	return file_proto_prysm_v1alpha1_beacon_core_types_proto_rawDescGZIP(), []int{16}
}
...
func (x *Deposit_Data) Reset() {
	*x = Deposit_Data{}
	mi := &file_proto_prysm_v1alpha1_beacon_core_types_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var file_proto_prysm_v1alpha1_beacon_core_types_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x77, 0x61, 0x62, 0x6c, 0x65, 0x45, 0x70, 0x6f, 0x63, 0x68, 0x22, 0x7c, 0x0a, 0x0c,
	...
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x72, 0x6f, 0x6f, 0x74, 0x42, 0x9e, 0x01, 0x0a, 0x19, 0x6f,
	0x72, 0x67, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x2e, 0x65, 0x74, 0x68, 0x2e,
	0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x42, 0x14, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e,
	0x43, 0x6f, 0x72, 0x65, 0x54, 0x79, 0x70, 0x65, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01,
...
var file_proto_prysm_v1alpha1_beacon_core_types_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_proto_prysm_v1alpha1_beacon_core_types_proto_goTypes = []any{
	...
	(*StateSummary)(nil),              // 16: ethereum.eth.v1alpha1.StateSummary
	(*Deposit_Data)(nil),              // 17: ethereum.eth.v1alpha1.Deposit.Data
...
var file_proto_prysm_v1alpha1_beacon_core_types_proto_depIdxs = []int32{
	...
	17, // 3: ethereum.eth.v1alpha1.Deposit.data:type_name -> ethereum.eth.v1alpha1.Deposit.Data
	...
	18, // 9: ethereum.eth.v1alpha1.IndexedAttestationElectra.data:type_name -> ethereum.eth.v1alpha1.AttestationData
	18, // 10: ethereum.eth.v1alpha1.IndexedAttestationGloas.data:type_name -> ethereum.eth.v1alpha1.AttestationData
