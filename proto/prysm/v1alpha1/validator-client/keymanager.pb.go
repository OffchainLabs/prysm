...
type SignRequest_BatchSealPreimage struct {
	BatchSealPreimage *v1alpha1.BatchSealPreimage `protobuf:"bytes,127,opt,name=batch_seal_preimage,json=batchSealPreimage,proto3,oneof"`
}

type SignRequest_BatcherPreimage struct {
	BatcherPreimage *v1alpha1.BatcherPreimage `protobuf:"bytes,128,opt,name=batcher_preimage,json=batcherPreimage,proto3,oneof"`
}
...
var file_proto_prysm_v1alpha1_validator_client_keymanager_proto_rawDesc = []byte{
	...
	0x74, 0x74, 0x65, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9e, 0x16, 0x0a, 0x0b, 0x53,
	...
	,
	...
	0x0a, 0x09, 0x5f, 0x67, 0x72, 0x61, 0x66, 0x66, 0x69, 0x74, 0x69, 0x22, 0xa5, 0x01, 0x0a, 0x0d,
...
var file_proto_prysm_v1alpha1_validator_client_keymanager_proto_goTypes = []any{
	...
	(*v1alpha1.BatchSealPreimage)(nil),                   // 29: ethereum.eth.v1alpha1.BatchSealPreimage
	(*v1alpha1.BatcherPreimage)(nil),                     // 30: ethereum.eth.v1alpha1.BatcherPreimage
}
var file_proto_prysm_v1alpha1_validator_client_keymanager_proto_depIdxs = []int32{
	...
	29, // 23: ethereum.validator.accounts.v2.SignRequest.batch_seal_preimage:type_name -> ethereum.eth.v1alpha1.BatchSealPreimage
	30, // 24: ethereum.validator.accounts.v2.SignRequest.batcher_preimage:type_name -> ethereum.eth.v1alpha1.BatcherPreimage
