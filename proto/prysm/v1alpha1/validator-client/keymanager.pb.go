...
type SignRequest struct {
	...
	//	*SignRequest_BuilderPreferencesRpc
...
func (x *SignRequest) GetBuilderPreferencesRpc() *v1alpha1.BuilderPreferencesRPC {
	if x != nil {
		if x, ok := x.Object.(*SignRequest_BuilderPreferencesRpc); ok {
			return x.BuilderPreferencesRpc
		}
	}
	return nil
}
...
type SignRequest_BuilderPreferencesRpc struct {
	BuilderPreferencesRpc *v1alpha1.BuilderPreferencesRPC `protobuf:"bytes,128,opt,name=builder_preferences_rpc,json=builderPreferencesRpc,proto3,oneof"`
}
...
func (*SignRequest_BuilderPreferencesRpc) isSignRequest_Object() {}
...
var file_proto_prysm_v1alpha1_validator_client_keymanager_proto_rawDesc = []byte{
	...
	0x50, 0x72, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x12, 0x47, 0x0a, 0x0c, 0x72, 0x65,
	...
	0x41, 0x75, 0x74, 0x68, 0x48, 0x00, 0x52, 0x0b, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x41,
	0x75, 0x74, 0x68, 0x12, 0x67, 0x0a, 0x17, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x65, 0x72, 0x5f, 0x70,
	0x72, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x73, 0x5f, 0x72, 0x70, 0x63, 0x18, 0x80,
	...
	0x52, 0x50, 0x43, 0x48, 0x00, 0x52, 0x15, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x65, 0x72, 0x50, 0x72,
	0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x73, 0x52, 0x70, 0x63, 0x12, 0x67, 0x0a, 0x0c,
...
var file_proto_prysm_v1alpha1_validator_client_keymanager_proto_goTypes = []any{
	...
	(*v1alpha1.RequestAuth)(nil),                         // 29: ethereum.eth.v1alpha1.RequestAuth
	(*v1alpha1.BuilderPreferencesRPC)(nil),               // 30: ethereum.eth.v1alpha1.BuilderPreferencesRPC
}
var file_proto_prysm_v1alpha1_validator_client_keymanager_proto_depIdxs = []int32{
	...
	29, // 23: ethereum.validator.accounts.v2.SignRequest.request_auth:type_name -> ethereum.eth.v1alpha1.RequestAuth
	30, // 24: ethereum.validator.accounts.v2.SignRequest.builder_preferences_rpc:type_name -> ethereum.eth.v1alpha1.BuilderPreferencesRPC
...
func file_proto_prysm_v1alpha1_validator_client_keymanager_proto_init() {
	...
	file_proto_prysm_v1alpha1_validator_client_keymanager_proto_msgTypes[0].OneofWrappers = []any{
		...
		(*SignRequest_BuilderPreferencesRpc)(nil),
	}
