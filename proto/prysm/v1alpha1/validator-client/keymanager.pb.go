...
type SignRequest struct {
	...
	//	*SignRequest_ProposerPreferences
...
func (x *SignRequest) GetProposerPreferences() *v1alpha1.ProposerPreferences {
	if x != nil {
		if x, ok := x.Object.(*SignRequest_ProposerPreferences); ok {
			return x.ProposerPreferences
		}
	}
	return nil
}
...
type SignRequest_ProposerPreferences struct {
	ProposerPreferences *v1alpha1.ProposerPreferences `protobuf:"bytes,126,opt,name=proposer_preferences,json=proposerPreferences,proto3,oneof"`
}
...
func (*SignRequest_ProposerPreferences) isSignRequest_Object() {}
...
var file_proto_prysm_v1alpha1_validator_client_keymanager_proto_rawDesc = []byte{
	...
	0x74, 0x74, 0x65, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xee, 0x14, 0x0a, 0x0b, 0x53,
	...
	0x73, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x44, 0x61, 0x74, 0x61, 0x12, 0x5f, 0x0a, 0x14, 0x70,
	0x72, 0x6f, 0x70, 0x6f, 0x73, 0x65, 0x72, 0x5f, 0x70, 0x72, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e,
	0x63, 0x65, 0x73, 0x18, 0x7e, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x65, 0x74, 0x68, 0x65,
	...
	0x65, 0x6e, 0x63, 0x65, 0x73, 0x48, 0x00, 0x52, 0x13, 0x70, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x65,
	0x72, 0x50, 0x72, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x73, 0x12, 0x67, 0x0a, 0x0c,
...
var file_proto_prysm_v1alpha1_validator_client_keymanager_proto_depIdxs = []int32{
	...
	28, // 22: ethereum.validator.accounts.v2.SignRequest.proposer_preferences:type_name -> ethereum.eth.v1alpha1.ProposerPreferences
...
func file_proto_prysm_v1alpha1_validator_client_keymanager_proto_init() {
	...
	file_proto_prysm_v1alpha1_validator_client_keymanager_proto_msgTypes[0].OneofWrappers = []any{
		...
		(*SignRequest_ProposerPreferences)(nil),
	}
