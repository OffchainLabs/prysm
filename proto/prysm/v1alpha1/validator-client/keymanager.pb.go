...
type SignRequest struct {
	...
	//	*SignRequest_ExecutionPayloadBid
...
func (x *SignRequest) GetExecutionPayloadBid() *v1alpha1.ExecutionPayloadBid {
	if x != nil {
		if x, ok := x.Object.(*SignRequest_ExecutionPayloadBid); ok {
			return x.ExecutionPayloadBid
		}
	}
	return nil
}
...
type SignRequest_ExecutionPayloadBid struct {
	ExecutionPayloadBid *v1alpha1.ExecutionPayloadBid `protobuf:"bytes,127,opt,name=execution_payload_bid,json=executionPayloadBid,proto3,oneof"`
}
...
func (*SignRequest_ExecutionPayloadBid) isSignRequest_Object() {}
...
var file_proto_prysm_v1alpha1_validator_client_keymanager_proto_rawDesc = []byte{
	...
	0x74, 0x74, 0x65, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xce, 0x15, 0x0a, 0x0b, 0x53,
	...
	0x50, 0x72, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x12, 0x60, 0x0a, 0x15, 0x65, 0x78,
	0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x5f,
	0x62, 0x69, 0x64, 0x18, 0x7f, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x65, 0x74, 0x68, 0x65,
	...
	0x61, 0x64, 0x42, 0x69, 0x64, 0x48, 0x00, 0x52, 0x13, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69,
	0x6f, 0x6e, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x42, 0x69, 0x64, 0x12, 0x67, 0x0a, 0x0c,
...
var file_proto_prysm_v1alpha1_validator_client_keymanager_proto_goTypes = []any{
	...
	(*v1alpha1.ExecutionPayloadBid)(nil),                 // 29: ethereum.eth.v1alpha1.ExecutionPayloadBid
}
var file_proto_prysm_v1alpha1_validator_client_keymanager_proto_depIdxs = []int32{
	...
	29, // 23: ethereum.validator.accounts.v2.SignRequest.execution_payload_bid:type_name -> ethereum.eth.v1alpha1.ExecutionPayloadBid
...
func file_proto_prysm_v1alpha1_validator_client_keymanager_proto_init() {
	...
	file_proto_prysm_v1alpha1_validator_client_keymanager_proto_msgTypes[0].OneofWrappers = []any{
		...
		(*SignRequest_ExecutionPayloadBid)(nil),
	}
