...
type SignRequest struct {
	...
	//	*SignRequest_BatchSealPreimage
	//	*SignRequest_BatcherPreimage
...
func (x *SignRequest) GetBatchSealPreimage() *v1alpha1.BatchSealPreimage {
	if x != nil {
		if x, ok := x.Object.(*SignRequest_BatchSealPreimage); ok {
			return x.BatchSealPreimage
		}
	}
	return nil
}

func (x *SignRequest) GetBatcherPreimage() *v1alpha1.BatcherPreimage {
	if x != nil {
		if x, ok := x.Object.(*SignRequest_BatcherPreimage); ok {
			return x.BatcherPreimage
		}
	}
	return nil
}
...
type SignRequest_BatchSealPreimage struct {
	BatchSealPreimage *v1alpha1.BatchSealPreimage `protobuf:"bytes,128,opt,name=batch_seal_preimage,json=batchSealPreimage,proto3,oneof"`
}

type SignRequest_BatcherPreimage struct {
	BatcherPreimage *v1alpha1.BatcherPreimage `protobuf:"bytes,129,opt,name=batcher_preimage,json=batcherPreimage,proto3,oneof"`
}
...
func (*SignRequest_BatchSealPreimage) isSignRequest_Object() {}

func (*SignRequest_BatcherPreimage) isSignRequest_Object() {}
...
type ProposerOptionPayload struct {
	...
	MaxExecutionPayment github_com_OffchainLabs_prysm_v7_consensus_types_validator.Uint64 `protobuf:"varint,5,opt,name=max_execution_payment,json=maxExecutionPayment,proto3" json:"max_execution_payment,omitempty" cast-type:"github.com/OffchainLabs/prysm/v7/consensus-types/validator.Uint64"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *ProposerOptionPayload) GetMaxExecutionPayment() github_com_OffchainLabs_prysm_v7_consensus_types_validator.Uint64 {
	if x != nil {
...
var file_proto_prysm_v1alpha1_validator_client_keymanager_proto_rawDesc = []byte{
	...
	0x65, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xea, 0x16, 0x0a, 0x0b, 0x53, 0x69, 0x67,
	...
	,
	...
	0x92, 0x03, 0x0a, 0x15, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x65, 0x72, 0x4f, 0x70, 0x74, 0x69,
	...
	,
	...
	0x20, 0x03, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x6c, 0x61, 0x79, 0x73, 0x22, 0x81, 0x03, 0x0a,
...
var file_proto_prysm_v1alpha1_validator_client_keymanager_proto_goTypes = []any{
	...
	(*v1alpha1.BatchSealPreimage)(nil),                   // 30: ethereum.eth.v1alpha1.BatchSealPreimage
	(*v1alpha1.BatcherPreimage)(nil),                     // 31: ethereum.eth.v1alpha1.BatcherPreimage
}
var file_proto_prysm_v1alpha1_validator_client_keymanager_proto_depIdxs = []int32{
	...
	30, // 24: ethereum.validator.accounts.v2.SignRequest.batch_seal_preimage:type_name -> ethereum.eth.v1alpha1.BatchSealPreimage
	31, // 25: ethereum.validator.accounts.v2.SignRequest.batcher_preimage:type_name -> ethereum.eth.v1alpha1.BatcherPreimage
	0,  // 26: ethereum.validator.accounts.v2.SignResponse.status:type_name -> ethereum.validator.accounts.v2.SignResponse.Status
	4,  // 27: ethereum.validator.accounts.v2.ProposerOptionPayload.builder:type_name -> ethereum.validator.accounts.v2.BuilderConfig
	6,  // 28: ethereum.validator.accounts.v2.ProposerSettingsPayload.proposer_config:type_name -> ethereum.validator.accounts.v2.ProposerSettingsPayload.ProposerConfigEntry
...
func file_proto_prysm_v1alpha1_validator_client_keymanager_proto_init() {
	...
	file_proto_prysm_v1alpha1_validator_client_keymanager_proto_msgTypes[0].OneofWrappers = []any{
		...
		(*SignRequest_BatchSealPreimage)(nil),
		(*SignRequest_BatcherPreimage)(nil),
	}
