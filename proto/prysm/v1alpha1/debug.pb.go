...
func (x *InclusionSlotRequest) GetSlot() github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.Slot {
	if x != nil {
		return x.Slot
	}
...
func (x *InclusionSlotResponse) GetSlot() github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.Slot {
	if x != nil {
		return x.Slot
	}
	return github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.Slot(0)
...
func (x *BeaconStateRequest) GetSlot() github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.Slot {
...
type BeaconStateRequest_Slot struct {
	Slot github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.Slot `protobuf:"varint,1,opt,name=slot,proto3,oneof" cast-type:"github.com/prysmaticlabs/prysm/v6/consensus-types/primitives.Slot"`
}
