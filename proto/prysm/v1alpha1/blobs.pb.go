...
type BlindedBlobSidecar struct {
	...
	Slot            github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.Slot           `protobuf:"varint,3,opt,name=slot,proto3" json:"slot,omitempty" cast-type:"github.com/prysmaticlabs/prysm/v6/consensus-types/primitives.Slot"`
	...
	ProposerIndex   github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.ValidatorIndex `protobuf:"varint,5,opt,name=proposer_index,json=proposerIndex,proto3" json:"proposer_index,omitempty" cast-type:"github.com/prysmaticlabs/prysm/v6/consensus-types/primitives.ValidatorIndex"`
...
func (x *BlindedBlobSidecar) GetSlot() github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.Slot {
	if x != nil {
		return x.Slot
	}
...
func (x *BlindedBlobSidecar) GetProposerIndex() github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.ValidatorIndex {
	if x != nil {
