...
func (c *LightClientBootstrapDataDeneb) SizeSSZ() int {
	size := 296
...
func (c *LightClientBootstrapDataDeneb) MarshalSSZ() ([]byte, error) {
	buf := make([]byte, c.SizeSSZ())
	return c.MarshalSSZTo(buf[:0])
}

func (c *LightClientBootstrapDataDeneb) MarshalSSZTo(dst []byte) ([]byte, error) {
	var err error
	offset := 296
...
func (c *LightClientBootstrapDataDeneb) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 296 {
		return ssz.ErrSize
...
func (c *LightClientBootstrapDataDeneb) HashTreeRoot() ([32]byte, error) {
	hh := ssz.DefaultHasherPool.Get()
	if err := c.HashTreeRootWith(hh); err != nil {
		ssz.DefaultHasherPool.Put(hh)
		return [32]byte{}, err
...
func (c *LightClientBootstrapDataDeneb) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	// Field 0: CurrentSyncCommittee
	{
		if len(c.CurrentSyncCommittee) > 1 {
...
func (c *LightClientEpochDataDeneb) SizeSSZ() int {
	size := 1980
	if c.BootstrapData == nil {
		c.BootstrapData = new(LightClientBootstrapDataDeneb)
	}
	size += c.BootstrapData.SizeSSZ()
	return size
}

func (c *LightClientEpochDataDeneb) MarshalSSZ() ([]byte, error) {
	buf := make([]byte, c.SizeSSZ())
	return c.MarshalSSZTo(buf[:0])
}

func (c *LightClientEpochDataDeneb) MarshalSSZTo(dst []byte) ([]byte, error) {
	var err error
	offset := 1980
...
func (c *LightClientEpochDataDeneb) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 1980 {
		return ssz.ErrSize
...
func (c *LightClientEpochDataDeneb) HashTreeRoot() ([32]byte, error) {
	hh := ssz.DefaultHasherPool.Get()
	if err := c.HashTreeRootWith(hh); err != nil {
		ssz.DefaultHasherPool.Put(hh)
		return [32]byte{}, err
...
func (c *LightClientEpochDataDeneb) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	// Field 0: Epoch
