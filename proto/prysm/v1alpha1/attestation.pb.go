...
type BatchSealPreimage struct {
	state          protoimpl.MessageState                                                     `protogen:"open.v1"`
	Slot           github_com_OffchainLabs_prysm_v7_consensus_types_primitives.Slot           `protobuf:"varint,1,opt,name=slot,proto3" json:"slot,omitempty" cast-type:"github.com/OffchainLabs/prysm/v7/consensus-types/primitives.Slot"`
	CommitteeIndex github_com_OffchainLabs_prysm_v7_consensus_types_primitives.CommitteeIndex `protobuf:"varint,2,opt,name=committee_index,json=committeeIndex,proto3" json:"committee_index,omitempty" cast-type:"github.com/OffchainLabs/prysm/v7/consensus-types/primitives.CommitteeIndex"`
	Batcher        github_com_OffchainLabs_prysm_v7_consensus_types_primitives.ValidatorIndex `protobuf:"varint,3,opt,name=batcher,proto3" json:"batcher,omitempty" cast-type:"github.com/OffchainLabs/prysm/v7/consensus-types/primitives.ValidatorIndex"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}

func (x *BatchSealPreimage) Reset() {
	*x = BatchSealPreimage{}
...
func (x *BatchSealPreimage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BatchSealPreimage) ProtoMessage() {}

func (x *BatchSealPreimage) ProtoReflect() protoreflect.Message {
	mi := &file_proto_prysm_v1alpha1_attestation_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BatchSealPreimage.ProtoReflect.Descriptor instead.
func (*BatchSealPreimage) Descriptor() ([]byte, []int) {
	return file_proto_prysm_v1alpha1_attestation_proto_rawDescGZIP(), []int{9}
}

func (x *BatchSealPreimage) GetSlot() github_com_OffchainLabs_prysm_v7_consensus_types_primitives.Slot {
	if x != nil {
		return x.Slot
	}
	return github_com_OffchainLabs_prysm_v7_consensus_types_primitives.Slot(0)
...
func (x *BatchSealPreimage) GetCommitteeIndex() github_com_OffchainLabs_prysm_v7_consensus_types_primitives.CommitteeIndex {
	if x != nil {
		return x.CommitteeIndex
	}
	return github_com_OffchainLabs_prysm_v7_consensus_types_primitives.CommitteeIndex(0)
...
func (x *BatchSealPreimage) GetBatcher() github_com_OffchainLabs_prysm_v7_consensus_types_primitives.ValidatorIndex {
	if x != nil {
		return x.Batcher
	}
	return github_com_OffchainLabs_prysm_v7_consensus_types_primitives.ValidatorIndex(0)
...
type BatcherPreimage struct {
	state           protoimpl.MessageState                                                     `protogen:"open.v1"`
	Slot            github_com_OffchainLabs_prysm_v7_consensus_types_primitives.Slot           `protobuf:"varint,1,opt,name=slot,proto3" json:"slot,omitempty" cast-type:"github.com/OffchainLabs/prysm/v7/consensus-types/primitives.Slot"`
	CommitteeIndex  github_com_OffchainLabs_prysm_v7_consensus_types_primitives.CommitteeIndex `protobuf:"varint,2,opt,name=committee_index,json=committeeIndex,proto3" json:"committee_index,omitempty" cast-type:"github.com/OffchainLabs/prysm/v7/consensus-types/primitives.CommitteeIndex"`
	AggregationBits github_com_OffchainLabs_go_bitfield.Bitlist                                `protobuf:"bytes,3,opt,name=aggregation_bits,json=aggregationBits,proto3" json:"aggregation_bits,omitempty" cast-type:"github.com/OffchainLabs/go-bitfield.Bitlist" ssz-max:"2048"`
	DataRoot        []byte                                                                     `protobuf:"bytes,4,opt,name=data_root,json=dataRoot,proto3" json:"data_root,omitempty" ssz-size:"32"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}

func (x *BatcherPreimage) Reset() {
	*x = BatcherPreimage{}
...
func (x *BatcherPreimage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BatcherPreimage) ProtoMessage() {}

func (x *BatcherPreimage) ProtoReflect() protoreflect.Message {
	mi := &file_proto_prysm_v1alpha1_attestation_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BatcherPreimage.ProtoReflect.Descriptor instead.
func (*BatcherPreimage) Descriptor() ([]byte, []int) {
	return file_proto_prysm_v1alpha1_attestation_proto_rawDescGZIP(), []int{10}
}

func (x *BatcherPreimage) GetSlot() github_com_OffchainLabs_prysm_v7_consensus_types_primitives.Slot {
	if x != nil {
		return x.Slot
	}
	return github_com_OffchainLabs_prysm_v7_consensus_types_primitives.Slot(0)
...
func (x *BatcherPreimage) GetCommitteeIndex() github_com_OffchainLabs_prysm_v7_consensus_types_primitives.CommitteeIndex {
	if x != nil {
		return x.CommitteeIndex
	}
	return github_com_OffchainLabs_prysm_v7_consensus_types_primitives.CommitteeIndex(0)
...
func (x *BatcherPreimage) GetAggregationBits() github_com_OffchainLabs_go_bitfield.Bitlist {
	if x != nil {
		return x.AggregationBits
	}
	return github_com_OffchainLabs_go_bitfield.Bitlist(nil)
...
func (x *BatcherPreimage) GetDataRoot() []byte {
	if x != nil {
		return x.DataRoot
	}
	return nil
...
type BatchAttestation struct {
	...
	AggregationBits  github_com_OffchainLabs_go_bitfield.Bitlist                                `protobuf:"bytes,2,opt,name=aggregation_bits,json=aggregationBits,proto3" json:"aggregation_bits,omitempty" cast-type:"github.com/OffchainLabs/go-bitfield.Bitlist" ssz-max:"2048"`
	Data             *AttestationData                                                           `protobuf:"bytes,3,opt,name=data,proto3" json:"data,omitempty"`
	Signature        []byte                                                                     `protobuf:"bytes,4,opt,name=signature,proto3" json:"signature,omitempty" ssz-size:"96"`
	Batcher          github_com_OffchainLabs_prysm_v7_consensus_types_primitives.ValidatorIndex `protobuf:"varint,5,opt,name=batcher,proto3" json:"batcher,omitempty" cast-type:"github.com/OffchainLabs/prysm/v7/consensus-types/primitives.ValidatorIndex"`
	BatchSeal        []byte                                                                     `protobuf:"bytes,6,opt,name=batch_seal,json=batchSeal,proto3" json:"batch_seal,omitempty" ssz-size:"96"`
	BatcherSignature []byte                                                                     `protobuf:"bytes,7,opt,name=batcher_signature,json=batcherSignature,proto3" json:"batcher_signature,omitempty" ssz-size:"96"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}

func (x *BatchAttestation) Reset() {
	*x = BatchAttestation{}
...
func (x *BatchAttestation) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BatchAttestation) ProtoMessage() {}

func (x *BatchAttestation) ProtoReflect() protoreflect.Message {
	mi := &file_proto_prysm_v1alpha1_attestation_proto_msgTypes[11]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BatchAttestation.ProtoReflect.Descriptor instead.
func (*BatchAttestation) Descriptor() ([]byte, []int) {
	return file_proto_prysm_v1alpha1_attestation_proto_rawDescGZIP(), []int{11}
}

func (x *BatchAttestation) GetCommitteeIndex() github_com_OffchainLabs_prysm_v7_consensus_types_primitives.CommitteeIndex {
	if x != nil {
		return x.CommitteeIndex
	}
	return github_com_OffchainLabs_prysm_v7_consensus_types_primitives.CommitteeIndex(0)
...
func (x *BatchAttestation) GetAggregationBits() github_com_OffchainLabs_go_bitfield.Bitlist {
	if x != nil {
		return x.AggregationBits
	}
	return github_com_OffchainLabs_go_bitfield.Bitlist(nil)
...
func (x *BatchAttestation) GetData() *AttestationData {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *BatchAttestation) GetSignature() []byte {
	if x != nil {
		return x.Signature
	}
	return nil
...
func (x *BatchAttestation) GetBatcher() github_com_OffchainLabs_prysm_v7_consensus_types_primitives.ValidatorIndex {
	if x != nil {
		return x.Batcher
	}
	return github_com_OffchainLabs_prysm_v7_consensus_types_primitives.ValidatorIndex(0)
...
func (x *BatchAttestation) GetBatchSeal() []byte {
	if x != nil {
		return x.BatchSeal
	}
	return nil
...
func (x *BatchAttestation) GetBatcherSignature() []byte {
	if x != nil {
		return x.BatcherSignature
	}
	return nil
}
...
var file_proto_prysm_v1alpha1_attestation_proto_rawDesc = []byte{
	...
	0xd0, 0x02, 0x0a, 0x11, 0x42, 0x61, 0x74, 0x63, 0x68, 0x53, 0x65, 0x61, 0x6c, 0x50, 0x72, 0x65,
	0x69, 0x6d, 0x61, 0x67, 0x65, 0x12, 0x58, 0x0a, 0x04, 0x73, 0x6c, 0x6f, 0x74, 0x18, 0x01, 0x20,
	...
	,
	...
	0x74, 0x74, 0x65, 0x65, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x62, 0x0a, 0x10, 0x61, 0x67, 0x67,
	0x72, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x62, 0x69, 0x74, 0x73, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x0c, 0x42, 0x37, 0x82, 0xb5, 0x18, 0x2b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	0x63, 0x6f, 0x6d, 0x2f, 0x4f, 0x66, 0x66, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x4c, 0x61, 0x62, 0x73,
	...
	0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x69, 0x74, 0x73, 0x12, 0x23, 0x0a,
	0x09, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x72, 0x6f, 0x6f, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c,
	0x42, 0x06, 0x8a, 0xb5, 0x18, 0x02, 0x33, 0x32, 0x52, 0x08, 0x64, 0x61, 0x74, 0x61, 0x52, 0x6f,
	0x6f, 0x74, 0x22, 0x97, 0x04, 0x0a, 0x10, 0x42, 0x61, 0x74, 0x63, 0x68, 0x41, 0x74, 0x74, 0x65,
	0x73, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x77, 0x0a, 0x0f, 0x63, 0x6f, 0x6d, 0x6d, 0x69,
	...
	0x62, 0x69, 0x74, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x42, 0x37, 0x82, 0xb5, 0x18, 0x2b,
	...
	0x42, 0x69, 0x74, 0x73, 0x12, 0x3a, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x03, 0x20, 0x01,
	...
	0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x68, 0x0a, 0x07, 0x62, 0x61, 0x74, 0x63, 0x68, 0x65,
	0x72, 0x18, 0x05, 0x20, 0x01, 0x28, 0x04, 0x42, 0x4e, 0x82, 0xb5, 0x18, 0x4a, 0x67, 0x69, 0x74,
	...
	0x6f, 0x72, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x52, 0x07, 0x62, 0x61, 0x74, 0x63, 0x68, 0x65, 0x72,
	0x12, 0x25, 0x0a, 0x0a, 0x62, 0x61, 0x74, 0x63, 0x68, 0x5f, 0x73, 0x65, 0x61, 0x6c, 0x18, 0x06,
	0x20, 0x01, 0x28, 0x0c, 0x42, 0x06, 0x8a, 0xb5, 0x18, 0x02, 0x39, 0x36, 0x52, 0x09, 0x62, 0x61,
	0x74, 0x63, 0x68, 0x53, 0x65, 0x61, 0x6c, 0x12, 0x33, 0x0a, 0x11, 0x62, 0x61, 0x74, 0x63, 0x68,
	0x65, 0x72, 0x5f, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x18, 0x07, 0x20, 0x01,
	0x28, 0x0c, 0x42, 0x06, 0x8a, 0xb5, 0x18, 0x02, 0x39, 0x36, 0x52, 0x10, 0x62, 0x61, 0x74, 0x63,
	0x68, 0x65, 0x72, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x42, 0x9a, 0x01, 0x0a,
...
var file_proto_prysm_v1alpha1_attestation_proto_goTypes = []any{
	...
	(*BatchSealPreimage)(nil),                         // 9: ethereum.eth.v1alpha1.BatchSealPreimage
	(*BatcherPreimage)(nil),                           // 10: ethereum.eth.v1alpha1.BatcherPreimage
	(*BatchAttestation)(nil),                          // 11: ethereum.eth.v1alpha1.BatchAttestation
}
var file_proto_prysm_v1alpha1_attestation_proto_depIdxs = []int32{
	...
	3,  // 9: ethereum.eth.v1alpha1.BatchAttestation.data:type_name -> ethereum.eth.v1alpha1.AttestationData
