...
type PendingDeposit struct {
	...
	Slot                  github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.Slot `protobuf:"varint,5,opt,name=slot,proto3" json:"slot,omitempty" cast-type:"github.com/prysmaticlabs/prysm/v6/consensus-types/primitives.Slot"`
}
...
func (x *PendingDeposit) GetSlot() github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.Slot {
	if x != nil {
		return x.Slot
	}
...
type PendingPartialWithdrawal struct {
	...
	WithdrawableEpoch github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.Epoch          `protobuf:"varint,3,opt,name=withdrawable_epoch,json=withdrawableEpoch,proto3" json:"withdrawable_epoch,omitempty" cast-type:"github.com/prysmaticlabs/prysm/v6/consensus-types/primitives.Epoch"`
}
...
func (x *PendingPartialWithdrawal) GetIndex() github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.ValidatorIndex {
	if x != nil {
		return x.Index
	}
...
func (x *PendingPartialWithdrawal) GetWithdrawableEpoch() github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.Epoch {
	if x != nil {
...
type PendingConsolidation struct {
	...
	SourceIndex github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.ValidatorIndex `protobuf:"varint,1,opt,name=source_index,json=sourceIndex,proto3" json:"source_index,omitempty" cast-type:"github.com/prysmaticlabs/prysm/v6/consensus-types/primitives.ValidatorIndex"`
	TargetIndex github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.ValidatorIndex `protobuf:"varint,2,opt,name=target_index,json=targetIndex,proto3" json:"target_index,omitempty" cast-type:"github.com/prysmaticlabs/prysm/v6/consensus-types/primitives.ValidatorIndex"`
}
...
func (x *PendingConsolidation) GetSourceIndex() github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.ValidatorIndex {
	if x != nil {
...
func (x *PendingConsolidation) GetTargetIndex() github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.ValidatorIndex {
	if x != nil {
