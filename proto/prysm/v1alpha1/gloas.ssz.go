...
func (c *PartialDataColumnGroupID) HashTreeRootWith(hh *ssz.Hasher) error {
	return c.ProgressiveHashTreeRootWith(hh)
}

var activeFieldsPartialDataColumnGroupID = []byte{0b00000011}

func (c *PartialDataColumnGroupID) ProgressiveHashTreeRoot() ([32]byte, error) {
	hh := ssz.DefaultHasherPool.Get()
	if err := c.ProgressiveHashTreeRootWith(hh); err != nil {
		ssz.DefaultHasherPool.Put(hh)
		return [32]byte{}, err
...
func (c *PartialDataColumnGroupID) ProgressiveHashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	// Field 0: Slot
	if err := c.Slot.HashTreeRootWith(hh); err != nil {
		return fmt.Errorf("Slot: %w", err)
	...
	hh.PutBytes(c.BeaconBlockRoot)
	hh.MerkleizeProgressiveWithActiveFields(indx, activeFieldsPartialDataColumnGroupID)
	return nil
}
...
func (c *PartialDataColumnSidecarGloas) HashTreeRootWith(hh *ssz.Hasher) error {
	return c.ProgressiveHashTreeRootWith(hh)
}

var activeFieldsPartialDataColumnSidecarGloas = []byte{0b00000111}

func (c *PartialDataColumnSidecarGloas) ProgressiveHashTreeRoot() ([32]byte, error) {
	hh := ssz.DefaultHasherPool.Get()
	if err := c.ProgressiveHashTreeRootWith(hh); err != nil {
		ssz.DefaultHasherPool.Put(hh)
		return [32]byte{}, err
...
func (c *PartialDataColumnSidecarGloas) ProgressiveHashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	// Field 0: CellsPresentBitmap
	...
	hh.MerkleizeProgressiveWithActiveFields(indx, activeFieldsPartialDataColumnSidecarGloas)
	return nil
}
