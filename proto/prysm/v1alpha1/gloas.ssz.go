...
func (c *LightClientBootstrapGloas) UnmarshalSSZ(buf []byte) error {
	...
	sszSlice1 := buf[496:25120]   // c.CurrentSyncCommittee
	sszSlice2 := buf[25120:25472] // c.CurrentSyncCommitteeBranch
...
func (c *LightClientUpdateGloas) UnmarshalSSZ(buf []byte) error {
	...
	sszSlice1 := buf[496:25120]   // c.NextSyncCommittee
	sszSlice2 := buf[25120:25472] // c.NextSyncCommitteeBranch
	sszSlice3 := buf[25472:25968] // c.FinalizedHeader
	sszSlice4 := buf[25968:26256] // c.FinalityBranch
	sszSlice5 := buf[26256:26416] // c.SyncAggregate
	sszSlice6 := buf[26416:26424] // c.SignatureSlot
...
func (c *LightClientFinalityUpdateGloas) UnmarshalSSZ(buf []byte) error {
	...
	sszSlice3 := buf[1280:1440] // c.SyncAggregate
	sszSlice4 := buf[1440:1448] // c.SignatureSlot
...
func (c *LightClientOptimisticUpdateGloas) UnmarshalSSZ(buf []byte) error {
	...
	sszSlice0 := buf[0:496]   // c.AttestedHeader
	sszSlice1 := buf[496:656] // c.SyncAggregate
	sszSlice2 := buf[656:664] // c.SignatureSlot
