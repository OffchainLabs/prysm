...
func (c *LightClientBlockDataGloas) UnmarshalSSZ(buf []byte) error {
	...
	sszSlice2 := buf[40:104]  // c.SyncCommitteeBits
	sszSlice3 := buf[104:136] // c.SyncCommitteeSignatureRoot
	sszSlice4 := buf[136:392] // c.SyncAggregateBranch
	...
	c.SyncCommitteeBits = append(c.SyncCommitteeBits, go_bitfield.Bitvector512(sszSlice2)...)
...
func (c *LightClientEpochDataGloas) UnmarshalSSZ(buf []byte) error {
	...
	sszSlice2 := buf[120:12664]   // c.BlockData
	sszSlice4 := buf[12668:12700] // c.FinalizedRoot
	sszSlice5 := buf[12700:12988] // c.FinalityBranch

	sszVarOffset3 := ssz.ReadOffset(buf[12664:12668]) // c.BootstrapData
	if sszVarOffset3 != 12988 {
		return ssz.ErrInvalidVariableOffset
	}
	if sszVarOffset3 > size {
		return ssz.ErrOffset
	...
	// Field 2: BlockData
	{
		c.BlockData = make([]*LightClientBlockDataGloas, 32)
		for i := 0; i < 32; i++ {
			var tmp *LightClientBlockDataGloas
			tmp = new(LightClientBlockDataGloas)
			tmpSlice := sszSlice2[i*392 : (1+i)*392]
			if err = tmp.UnmarshalSSZ(tmpSlice); err != nil {
