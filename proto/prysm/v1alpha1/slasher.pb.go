...
type HighestAttestation struct {
	...
	HighestSourceEpoch github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.Epoch `protobuf:"varint,2,opt,name=highest_source_epoch,json=highestSourceEpoch,proto3" json:"highest_source_epoch,omitempty" cast-type:"github.com/prysmaticlabs/prysm/v6/consensus-types/primitives.Epoch"`
	HighestTargetEpoch github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.Epoch `protobuf:"varint,3,opt,name=highest_target_epoch,json=highestTargetEpoch,proto3" json:"highest_target_epoch,omitempty" cast-type:"github.com/prysmaticlabs/prysm/v6/consensus-types/primitives.Epoch"`
}
...
func (x *HighestAttestation) GetHighestSourceEpoch() github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.Epoch {
	if x != nil {
...
func (x *HighestAttestation) GetHighestTargetEpoch() github_com_prysmaticlabs_prysm_v6_consensus_types_primitives.Epoch {
	if x != nil {
