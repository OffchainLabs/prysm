...
func (x *SyncAggregatorSelectionData) Reset() {
	*x = SyncAggregatorSelectionData{}
	mi := &file_proto_prysm_v1alpha1_sync_committee_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SyncAggregatorSelectionData) Descriptor() ([]byte, []int) {
	return file_proto_prysm_v1alpha1_sync_committee_proto_rawDescGZIP(), []int{4}
}
...
var file_proto_prysm_v1alpha1_sync_committee_proto_rawDesc = []byte{
	...
	0x02, 0x39, 0x36, 0x52, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0xa6,
	...
	0x65, 0x65, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x42, 0x96, 0x01, 0x0a, 0x19, 0x6f, 0x72, 0x67, 0x2e,
	...
	0x74, 0x74, 0x65, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x39, 0x67, 0x69, 0x74,
...
var file_proto_prysm_v1alpha1_sync_committee_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_proto_prysm_v1alpha1_sync_committee_proto_goTypes = []any{
	...
	(*SyncAggregatorSelectionData)(nil), // 4: ethereum.eth.v1alpha1.SyncAggregatorSelectionData
}
