...
type ZKVMExecutionLayerConfig struct {
	...
	GenerationProofTypes map[primitives.ExecutionProofId]struct{}
...
func NewDefaultZKVMExecutionLayerConfig() *ZKVMExecutionLayerConfig {
	return &ZKVMExecutionLayerConfig{
		MinProofsRequired:    1,
		GenerationProofTypes: make(map[primitives.ExecutionProofId]struct{}),
		ProofCacheSize:       64 * 8,
	}
}
...
func (b *ZKVMExecutionLayerConfigBuilder) GenerationSubnets(subnets map[primitives.ExecutionProofId]struct{}) *ZKVMExecutionLayerConfigBuilder {
	b.generationProofTypes = subnets
	return b
}

// AddGenerationSubnet adds a single subnet to the generation set.
func (b *ZKVMExecutionLayerConfigBuilder) AddGenerationSubnet(subnet primitives.ExecutionProofId) *ZKVMExecutionLayerConfigBuilder {
