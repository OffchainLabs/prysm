...
import (
	...
	lightclientCore "github.com/prysmaticlabs/prysm/v5/beacon-chain/core/light-client"
...
func CreateTestingUpdate(t *testing.T, v int) (interfaces.LightClientUpdate, error) {
	...
	update, err := lightclientCore.CreateDefaultLightClientUpdate(slot)
	require.NoError(t, err)
