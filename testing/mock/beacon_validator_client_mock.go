...
// Source: github.com/OffchainLabs/prysm/v7/proto/prysm/v1alpha1 (interfaces: BeaconNodeValidatorClient,BeaconNodeValidator_WaitForChainStartClient,BeaconNodeValidator_WaitForActivationClient,BeaconNodeValidator_StreamSlotsClient,BeaconNodeValidator_StreamExecutionPayloadAvailableClient)
//
// Generated by this command:
//
//	mockgen -package=mock -destination=testing/mock/beacon_validator_client_mock.go github.com/OffchainLabs/prysm/v7/proto/prysm/v1alpha1 BeaconNodeValidatorClient,BeaconNodeValidator_WaitForChainStartClient,BeaconNodeValidator_WaitForActivationClient,BeaconNodeValidator_StreamSlotsClient,BeaconNodeValidator_StreamExecutionPayloadAvailableClient
//
...
// StreamExecutionPayloadAvailable mocks base method.
func (m *MockBeaconNodeValidatorClient) StreamExecutionPayloadAvailable(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (eth.BeaconNodeValidator_StreamExecutionPayloadAvailableClient, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "StreamExecutionPayloadAvailable", varargs...)
	ret0, _ := ret[0].(eth.BeaconNodeValidator_StreamExecutionPayloadAvailableClient)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// StreamExecutionPayloadAvailable indicates an expected call of StreamExecutionPayloadAvailable.
func (mr *MockBeaconNodeValidatorClientMockRecorder) StreamExecutionPayloadAvailable(ctx, in any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, in}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StreamExecutionPayloadAvailable", reflect.TypeOf((*MockBeaconNodeValidatorClient)(nil).StreamExecutionPayloadAvailable), varargs...)
}
...
// MockBeaconNodeValidator_StreamExecutionPayloadAvailableClient is a mock of BeaconNodeValidator_StreamExecutionPayloadAvailableClient interface.
type MockBeaconNodeValidator_StreamExecutionPayloadAvailableClient struct {
	ctrl     *gomock.Controller
	recorder *MockBeaconNodeValidator_StreamExecutionPayloadAvailableClientMockRecorder
	isgomock struct{}
}

// MockBeaconNodeValidator_StreamExecutionPayloadAvailableClientMockRecorder is the mock recorder for MockBeaconNodeValidator_StreamExecutionPayloadAvailableClient.
type MockBeaconNodeValidator_StreamExecutionPayloadAvailableClientMockRecorder struct {
	mock *MockBeaconNodeValidator_StreamExecutionPayloadAvailableClient
}

// NewMockBeaconNodeValidator_StreamExecutionPayloadAvailableClient creates a new mock instance.
func NewMockBeaconNodeValidator_StreamExecutionPayloadAvailableClient(ctrl *gomock.Controller) *MockBeaconNodeValidator_StreamExecutionPayloadAvailableClient {
	mock := &MockBeaconNodeValidator_StreamExecutionPayloadAvailableClient{ctrl: ctrl}
	mock.recorder = &MockBeaconNodeValidator_StreamExecutionPayloadAvailableClientMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockBeaconNodeValidator_StreamExecutionPayloadAvailableClient) EXPECT() *MockBeaconNodeValidator_StreamExecutionPayloadAvailableClientMockRecorder {
	return m.recorder
}

// CloseSend mocks base method.
func (m *MockBeaconNodeValidator_StreamExecutionPayloadAvailableClient) CloseSend() error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CloseSend")
	ret0, _ := ret[0].(error)
	return ret0
...
// CloseSend indicates an expected call of CloseSend.
func (mr *MockBeaconNodeValidator_StreamExecutionPayloadAvailableClientMockRecorder) CloseSend() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CloseSend", reflect.TypeOf((*MockBeaconNodeValidator_StreamExecutionPayloadAvailableClient)(nil).CloseSend))
}

// Context mocks base method.
func (m *MockBeaconNodeValidator_StreamExecutionPayloadAvailableClient) Context() context.Context {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Context")
	ret0, _ := ret[0].(context.Context)
	return ret0
...
// Context indicates an expected call of Context.
func (mr *MockBeaconNodeValidator_StreamExecutionPayloadAvailableClientMockRecorder) Context() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Context", reflect.TypeOf((*MockBeaconNodeValidator_StreamExecutionPayloadAvailableClient)(nil).Context))
}

// Header mocks base method.
func (m *MockBeaconNodeValidator_StreamExecutionPayloadAvailableClient) Header() (metadata.MD, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Header")
	ret0, _ := ret[0].(metadata.MD)
	ret1, _ := ret[1].(error)
...
// Header indicates an expected call of Header.
func (mr *MockBeaconNodeValidator_StreamExecutionPayloadAvailableClientMockRecorder) Header() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Header", reflect.TypeOf((*MockBeaconNodeValidator_StreamExecutionPayloadAvailableClient)(nil).Header))
}

// Recv mocks base method.
func (m *MockBeaconNodeValidator_StreamExecutionPayloadAvailableClient) Recv() (*eth.StreamExecutionPayloadAvailableResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Recv")
	ret0, _ := ret[0].(*eth.StreamExecutionPayloadAvailableResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// Recv indicates an expected call of Recv.
func (mr *MockBeaconNodeValidator_StreamExecutionPayloadAvailableClientMockRecorder) Recv() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Recv", reflect.TypeOf((*MockBeaconNodeValidator_StreamExecutionPayloadAvailableClient)(nil).Recv))
}

// RecvMsg mocks base method.
func (m_2 *MockBeaconNodeValidator_StreamExecutionPayloadAvailableClient) RecvMsg(m any) error {
	m_2.ctrl.T.Helper()
	ret := m_2.ctrl.Call(m_2, "RecvMsg", m)
	ret0, _ := ret[0].(error)
	return ret0
...
// RecvMsg indicates an expected call of RecvMsg.
func (mr *MockBeaconNodeValidator_StreamExecutionPayloadAvailableClientMockRecorder) RecvMsg(m any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RecvMsg", reflect.TypeOf((*MockBeaconNodeValidator_StreamExecutionPayloadAvailableClient)(nil).RecvMsg), m)
}

// SendMsg mocks base method.
func (m_2 *MockBeaconNodeValidator_StreamExecutionPayloadAvailableClient) SendMsg(m any) error {
	m_2.ctrl.T.Helper()
	ret := m_2.ctrl.Call(m_2, "SendMsg", m)
	ret0, _ := ret[0].(error)
	return ret0
...
// SendMsg indicates an expected call of SendMsg.
func (mr *MockBeaconNodeValidator_StreamExecutionPayloadAvailableClientMockRecorder) SendMsg(m any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendMsg", reflect.TypeOf((*MockBeaconNodeValidator_StreamExecutionPayloadAvailableClient)(nil).SendMsg), m)
}

// Trailer mocks base method.
func (m *MockBeaconNodeValidator_StreamExecutionPayloadAvailableClient) Trailer() metadata.MD {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Trailer")
	ret0, _ := ret[0].(metadata.MD)
	return ret0
...
// Trailer indicates an expected call of Trailer.
func (mr *MockBeaconNodeValidator_StreamExecutionPayloadAvailableClientMockRecorder) Trailer() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Trailer", reflect.TypeOf((*MockBeaconNodeValidator_StreamExecutionPayloadAvailableClient)(nil).Trailer))
}
