...
const (
	...
	// Eth1StaticFilesPath is repo-root-relative so build/bazel.Runfile resolves it from the
	// source tree under the Go toolchain (a leading slash would be treated as an absolute
	// filesystem path and never found).
