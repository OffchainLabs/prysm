...
func RunLightClientSingleMerkleProofTests(t *testing.T, config string) {
	...
	_, testsFolderPath := utils.TestFolders(t, config, "bellatrix", "light_client/single_merkle_proof")
	...
	for _, testType := range testTypes {
		testFolders, testsFolderPath := utils.TestFolders(t, config, "bellatrix", fmt.Sprintf("light_client/single_merkle_proof/%s", testType))
