...
**Prysm hasn't yet implemented the ecosystem standard.** Prysm currently just shows `"Prysm/v5.1.0"` with no EL info.

**Why it matters**: On-chain visibility of client diversity is much easier in this case.
...
|-----------|--------------|-----|
| **Blockchain Service** | Initialize cache + graffiti service on startup, spawn refresh goroutine | Central place to manage lifecycle of new components |
