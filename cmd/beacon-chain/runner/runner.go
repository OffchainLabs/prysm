// Package runner defines the CLI runtime for an Ethereum beacon node.
package runner
...
// Run starts the beacon-chain CLI with the supplied argv.
...
// NewApp returns the beacon-chain CLI app.
