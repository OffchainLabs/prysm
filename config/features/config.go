...
type Flags struct {
	...
	UseSSZ                              bool // UseSSZ enables the validator client to call the beacon node with ssz instead of json when rest mode is enabled, debugging
