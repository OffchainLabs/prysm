...
var (
	...
	// EnableSSZ enables api calls to use rest between the validator client and the beacon node
	EnableSSZ = &cli.BoolFlag{
		Name:  "enable-ssz",
		Usage: "(Experimental): Enables the validator client to use SSZ encoding for REST API calls.",
	}
)
