...
func TestProposeBeaconBlock_BlindedCapella(t *testing.T) {
	...
	jsonBlindedCapellaBlock := &structs.SignedBlindedBeaconBlockCapella{
		...
		Message: &structs.BlindedBeaconBlockCapella{
			...
			ProposerIndex: httputil.Uint64ToString(blindedCapellaBlock.BlindedCapella.Block.ProposerIndex),
			Slot:          httputil.Uint64ToString(blindedCapellaBlock.BlindedCapella.Block.Slot),
			...
			Body: &structs.BlindedBeaconBlockBodyCapella{
				...
				ExecutionPayloadHeader: &structs.ExecutionPayloadHeaderCapella{
					...
					BlockNumber:      httputil.Uint64ToString(blindedCapellaBlock.BlindedCapella.Block.Body.ExecutionPayloadHeader.BlockNumber),
					...
					GasLimit:         httputil.Uint64ToString(blindedCapellaBlock.BlindedCapella.Block.Body.ExecutionPayloadHeader.GasLimit),
					GasUsed:          httputil.Uint64ToString(blindedCapellaBlock.BlindedCapella.Block.Body.ExecutionPayloadHeader.GasUsed),
					...
					Timestamp:        httputil.Uint64ToString(blindedCapellaBlock.BlindedCapella.Block.Body.ExecutionPayloadHeader.Timestamp),
