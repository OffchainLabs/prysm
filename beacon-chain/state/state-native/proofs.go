...
func (b *BeaconState) CurrentSyncCommitteeProof(ctx context.Context) ([][]byte, error) {
	...
	return trie.ProofFromMerkleLayers(b.merkleLayers.layers, types.CurrentSyncCommittee.RealPosition()), nil
}
...
func (b *BeaconState) NextSyncCommitteeProof(ctx context.Context) ([][]byte, error) {
	...
	return trie.ProofFromMerkleLayers(b.merkleLayers.layers, types.NextSyncCommittee.RealPosition()), nil
}
...
func (b *BeaconState) FinalizedRootProof(ctx context.Context) ([][]byte, error) {
	...
	branch := trie.ProofFromMerkleLayers(b.merkleLayers.layers, types.FinalizedCheckpoint.RealPosition())
