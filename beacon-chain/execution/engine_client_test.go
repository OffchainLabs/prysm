...
func TestConstructDataColumnSidecars(t *testing.T) {
	...
	t.Run("GetBlobsV2 is not supported", func(t *testing.T) {
		_, _, err := client.ConstructDataColumnSidecars(ctx, peerdas.PopulateFromBlock(roBlock), true)
	...
	t.Run("nothing received", func(t *testing.T) {
		...
		dataColumns, _, err := client.ConstructDataColumnSidecars(ctx, peerdas.PopulateFromBlock(roBlock), true)
		require.NoError(t, err)
